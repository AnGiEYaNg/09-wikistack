...
// /* GET home page. */
// router.get('/', function(req, res, next) {
// 	//get all pages from page model
// 	//render index with those pages
// 	models.Page
// 	.find()
// 	.exec()
...
// 	// 	res.render('index', { title: 'WIKISTACK', docs:data, tags:data });
// 	// })
  	
// });

// router.get('/wiki/:page_name', function(req, res, next) {
// 	var url_name=req.params.page_name;
